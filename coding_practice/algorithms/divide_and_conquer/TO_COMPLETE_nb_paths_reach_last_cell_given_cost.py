...
Find the total N of paths to reach the end within the given total cost
"""
...
def find_paths(
    ...
    if i == rows - 1:
        return find_paths(matrix, remaining_cost, i, j + 1)
    elif j == cols - 1:
        return find_paths(matrix, remaining_cost, i + 1, j)
